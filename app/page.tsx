    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">Why Choose Our PDF Merger?</h2>
      ...
      <section className="py-24 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-background p-8 md:p-12">
            <div className="absolute inset-0 bg-grid-white/10" />
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-2xl space-y-4">
                <h2 className="text-3xl md:text-4xl font-bold">Ready to merge your PDFs?</h2>
